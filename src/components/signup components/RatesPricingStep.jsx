...
const RatesPricingStep = ({ formData, setFormData, onNext, onPrev }) => {
  ...
  return (
    <div className="w-full max-w-3xl bg-white rounded-lg p-8 border">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
        <div>
          ...
          <input
            ...
            className={`mt-1 block w-full form-input border text-xs ${
              errors.rates ? "border-red-400" : "border-none"
            } rounded-md p-2`}
        ...
        <div>
          ...
          <input
            ...
            className={`mt-1 block w-full bg-gray-100 border text-xs ${
              errors.rates ? "border-red-400" : "border-none"
            } rounded-md p-2`}
            placeholder={t("rates_pricing.placeholder")}
          />
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 items-center mb-6">
        <div>
          ...
          <select
            ...
            className="mt-1 block w-full form-input border border-none rounded-md p-2 text-xs"
          >
          ...
          >
            <span
              className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${
                localNegotiable ? "translate-x-5" : "translate-x-0"
              }`}
            />
          </button>
          <label className="ml-3 text-xs font-semibold">
      ...
      {/* Error message */}
      {errors.rates && (
        <div className="mb-6 text-xs text-red-600 bg-red-50 border border-red-300 rounded-md p-3">
          {errors.rates}
        </div>
      )}
