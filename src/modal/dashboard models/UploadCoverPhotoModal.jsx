...
import { uploadCoverPhotoMedia, uploadProfileMedia } from "../../Hooks/useDashboard";
import toast from "react-hot-toast";

const ACCEPTED_TYPES = ["image/jpeg", "image/png", "image/webp", "image/gif", "video/mp4", "video/webm"];
const MAX_SIZE_BYTES = 10 * 1024 * 1024;

const UploadCoverPhotoModal = ({ isOpen, onClose, uuid, onSaved }) => {
  ...
  const handleUpload = async () => {
    ...
    try {
      const result = await uploadCoverPhotoMedia({
        uuid,
        file,
