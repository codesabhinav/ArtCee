...
const LandingPage = ({ onClose, isModal = false }) => {
  ...
  `}
        >
          ...
          >
            <div className="absolute top-4 right-4 rounded-lg px-2 py-1.5 text-xs font-semibold hover:bg-gray-100">
              <X className="w-5 h-5"
                onClick={closeLanding}
              />
            </div>
            ...
            <div
              className={
                isModal
                  ? "p-6 flex flex-col items-center justify-center bg-white text-center rounded-2xl"
                  : "min-h-screen p-10 flex flex-col items-center justify-center bg-gradient-to-b from-gray-50 to-gray-100 px-4 text-center"
              }
            >
              <img src="logo.png" className="h-20 w-20 mb-6" alt="logo" />
        ...
        <p className="text-gray-500 mt-4 text-center max-w-lg">
          ...
          <StarIcon className="text-orange-400 h-4 w-4" /> Join thousands of artsy people building their careers on ArtCee
              ...
              <p className="text-gray-400 text-xs mt-8">
                ...
                <button className="text-teal-500">{t("landing.terms")}</button>
                &nbsp;{t("landing.and")}&nbsp;
